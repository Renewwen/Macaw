...
public class MongoDBTableCreation {
	...
	public static void main(String[] args) throws ParseException {
		...
		MongoClient mongoClient = MongoClients.create(); // omit: create(localhost, 27017)
		...
		// new document(): just to change the format to SQL "{" "}", not really create a document object!
